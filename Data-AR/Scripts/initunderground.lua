...
local sectorList = {
    ...
    -- Miguel's basement
    { location = "A10-1", loadscreens = { "LS_ComplexBsmnt", "LS_Upstairs" }, },
    ...
    -- Meduna
    { location = "O3-1", loadscreens = { "LS_Tunnels", "LS_Upstairs" }, },
    ...
    -- New
    { location = "G11-1", }, loadscreen = { "LS_ComplexBsmnt", },
    { location = "J9-3", loadscreen = "LS_Tunnels", },
    
    
    -- Demoville
    { location = "P1-1", loadscreens = { "LS_Basement", "LS_Upstairs" }, },
    {
      location = "P1-2", loadscreen = "LS_Tunnels",
...
local function PopulateSectors(difficultyLevel, gameStyle)
    ...
    -- new
    s["G11-1"].numTroops = 6 + 2*difficultyLevel + math.random(0, 2)
    s["G11-1"].numElites = 4 +   difficultyLevel + math.random(0, 1)
